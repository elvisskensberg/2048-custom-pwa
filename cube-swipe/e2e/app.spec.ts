...
test.describe('Cube Swipe 2048 App', () => {
  test('should load and take screenshot on iPhone 14', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/app-home-iphone14.png', fullPage: true, scale: 'device' })
  })
  ...
  test('should navigate to game screen', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/app-game-iphone14.png', fullPage: true, scale: 'device' })
  })
  ...
  test('should navigate to About screen', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/app-about-iphone14.png', fullPage: true, scale: 'device' })
  })
  ...
  test('should navigate to Leave Comment screen', async ({ page }) => {
    ...
    await page.screenshot({ path: 'e2e/screenshots/app-comments-iphone14.png', fullPage: true, scale: 'device' })
  })

  test('should toggle theme', async ({ page }) => {
    await page.goto('/')
    await page.screenshot({ path: 'e2e/screenshots/app-light-mode-iphone14.png', fullPage: true, scale: 'device' })
    await page.getByLabel('Toggle theme').click()
    await page.waitForTimeout(500)
    await page.screenshot({ path: 'e2e/screenshots/app-dark-mode-iphone14.png', fullPage: true, scale: 'device' })
  })
})
